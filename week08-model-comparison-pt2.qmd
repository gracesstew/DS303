...
uniforms_long <- lm(Size ~ Height + Weight + Height:Weight, data = Student_stats) #best model

uniforms_2 <- lm(Size ~ Height + Height:Weight, data = Student_stats) #p vlaue = 0.3

uniforms_3  <- lm(Size ~ Weight + Height:Weight, data = Student_stats)

uniforms_4 <- lm(Size ~  Height + Weight, data = Student_stats)
...
mmm <- lm(mpg ~ gear + cyl + hp, data = mtcars)
AIC(m.best, mmm)
