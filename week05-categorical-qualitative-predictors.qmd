...
-   `ShelveLocGood`: When on a Good shelf....

-   `ShelveLocMedium`: When on a Medium shelf....

-   `R-squared`: This model explains....

-   `F-statistic`: The low F-statistic and a high *p*-value indicates....
